  ...
  const socialLinks = [
    {
      ...
      href: "mailto:contact@bezamekonnen.com",
      text: "contact@bezamekonnen.com",
    },
    {
      name: "GitHub",
      icon: (
      ...
      href: "https://github.com/BezaMek?tab=repositories",
      text: "@BezaMek",
    },
    {
      name: "LinkedIn",
      ...
      href: "https://linkedin.com/in/beza-mekonnen",
      text: "Beza Mekonnen",
    },
  ];
              ...
              <div className="space-y-6">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="flex items-center space-x-4 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-300 group"
                  >
